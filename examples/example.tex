...
\begin{figure}[H]
	...
	\caption{Mean SHD with varying edge probabilities and oracle accuracy. Compared to Hill-Climb Search with BIC score}
\end{figure}
\begin{figure}[H]
	\centering
	\includegraphics[scale=0.7]{../code/plots/shd_pruned.pdf}
	\caption{Mean SHD with varying edge probabilities and oracle accuracy. Compared to Hill-Climb Search with BIC score}
\end{figure}
