...
\begin{figure}[H]
	\begin{subfigure}{0.5 \textwidth}
		\begin{tikzpicture}[scale=2]
				...
				\node (x1) at (1, 0.5) {$ x3 $};
				\node (Y) at (2, 0) {$ Y $};
				\draw [->] (x1) -- (X) node[midway, above, sloped] {$0.3$};
				\draw [->] (x2) -- (Y) node[midway, above, sloped] {$0.3$};
				\draw [->] (x3) -- (Y) node[midway, above, sloped] {$0.3$};
				\draw [->] (X) -- (x2) node[midway, above, sloped] {$0.3$};
				\draw [->] (X) -- (x3) node[midway, above, sloped] {$0.3$};
		\end{tikzpicture}
	\end{subfigure}%
	\begin{subfigure}{0.5 \textwidth}
	\end{subfigure}
...
\begin{figure}[H]
	\begin{subfigure}{0.5 \textwidth}
		\begin{tikzpicture}[scale=2]
				...
				\node (Y) at (2, 0) {$ Y $};
				\draw [->] (x1) -- (X) node[midway, above, sloped] {$0.3$};
				\draw [dashed] (x2) -- (Y) node[midway, above, sloped] {$0.3$};
				\draw [dashed] (x3) -- (Y) node[midway, above, sloped] {$0.3$};
