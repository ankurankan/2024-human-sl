...
\begin{document}
	...
	\begin{tikzpicture}
	\begin{scope}[xscale=1.2, yscale=1.5]
		...
		\node (age) at (2.5, 0)    {\footnotesize{Age}};
		\node (inc) at (2.5, -0.8) {\footnotesize{Income}};
		\node (occ) at (2.5, -1.6) {\footnotesize{Occupation}};
		\node (wc)  at (2.5, -2.4) {\footnotesize{Work Class}};

		\node (nc)   at (5, 0)    {\footnotesize{Native Country}};
		\node (race) at (5, -0.8) {\footnotesize{Race}};
		\node (edu)  at (5, -1.6) {\footnotesize{Education}};
