...
variables from observational data. Methods for causal discovery have been
developed in both the Directed Acyclic Graphs (DAGs) and Structural Equation
Models (SEMs) literatures, each adopting a different approach. 
