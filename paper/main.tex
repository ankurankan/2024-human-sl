...
Then $H^+ \subseteq \tilde{G} \supseteq G$. If $H$ contains at least one cycle, then
$H^+ \subsetneq \tilde{G}$.
...
would be cyclic. At least one edge of every cycle is therefore removed by
 $\textsc{FixCycles}$, making the result acyclic again. Since the removed edges need
to be in $H^+$, the first inclusion is strict for cyclic $H$.
\end{proof}
