...
Even when using automated algorithms, we often have to rely on manual post hoc
...
\begin{enumerate}
	\item \textbf{Make Obvious Mistakes:} Although most algorithms are
		...
		make obvious mistakes. Consequently, researchers have to rely on
...
\end{enumerate}
\todo[inline]{The second point doesn't seem to be adding much}
...
\begin{figure}
	...
	\begin{tikzpicture}
		...
		\end{scope}
		\end{tikzpicture}
		\caption{\todo[inline]{Finish figure. Show an example of model testing using CIs}}
