...
Para 1: Many Causal discovery algorithms but commonly constructed manually.

To perform any causal effect identification or estimation in Directed Acyclic
Graph(DAG) based causal inference usually requires to come up with the DAG
structure. Learning these DAG structures from data is known as \emph{causal
discovery}. Plenty of algorithms have been developed for these in the
literature such as constraint-based methods such as PC, FCI, score based
methods such as Hill-Climb Search, GES, and constrained continuous optimization
based such as No TEARS.

Para 2: Reasons behind this
...
Para 4: Mixed data testing

One of the limitations here is there are no effect size measures available for 
