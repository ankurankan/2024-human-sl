...
the model accordingly. However, this CI based testing has a few drawbacks: 1) CIs
...
\caption{Markov Equivalence Class (MEC) learnt for Adult Income Dataset using (a) PC algorithm, (b) Hill-Climb Search with BIC score, (c) }
\label{fig:intro}
\end{figure}
