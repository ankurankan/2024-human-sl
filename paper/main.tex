...
As we saw in the previous section, depending on the type of variable, different
conditional measures of association are used. However, no generalized measure
of association exists for mixed data. In this section, we present a novel
measure of partial association for mixed data. This measure of association is
analogous to partial correlation coefficient where a residualization method is
combined with Pearson correlation coefficient. Here, we use a mixed data
residualization method \citep{Ankan2023} and combine it with a multivariate
measure of association based on canonical correlations called Pillai's Trace
{Pillai1955}.
