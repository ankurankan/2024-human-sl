...
\begin{figure}[t!]
	...
	\begin{subfigure}{0.17 \textwidth}
		...
		\caption{Orient $ X_1 \rightarrow X_4 $}
	\end{subfigure}
	\begin{subfigure}{0.17 \textwidth}
		\includegraphics[page=4]{example.pdf}
		\caption{Orient $ X_1 \rightarrow X_2 $}
	\end{subfigure}%
	\begin{subfigure}{0.17 \textwidth}
	...
	\begin{subfigure}{0.17 \textwidth}
		...
		\caption{Orient $ X_2 \rightarrow X_4 $}
	\end{subfigure}
	\begin{subfigure}{0.17 \textwidth}
		\includegraphics[page=7]{example.pdf}
		\caption{Expand $ X_3 \rightarrow X_4 $. Prune $ X_1 \rightarrow X_4 $.}
	\end{subfigure}
