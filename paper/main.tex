...
Figure~\ref{fig:intro} highlights some of these issues. When constructing DAGs
manually, it is important to test how consistent our DAG is to our dataset. One
of the methods for checking the consistency is by testing whether the implied
CIs of the DAG hold in the dataset or not \citep{Ankan2021}. As each pair of
variables that do not have an edge between them in the DAG implies a CI
statement, we can use a statistical test to check whether that statement holds
