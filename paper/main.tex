...
\todo[inline]{Add a table here}
% \begin{figure}
% 	\centering
% 	\begin{tabular}{llrr}
% 		\multicolumn{4}{c}{Z=Age, Sex} \\
% 		$X$ & $Y$ & \bm{Z} & p \\
% 		\hline
% 		Edct & Wrkc & 1.00  \\
% 		Occp & Wrkc & 1.00  \\
...
an $ \mathrm{Expert} $ with accuracy $ \alpha $, has an effective accuracy:
...
, we use the
\textsc{RankedExpand} method together with a version of the strong ancestral
oracle that can make mistakes.
...
the effect size measure (Section~\ref{ref:ci_tests}). For the analysis, we
