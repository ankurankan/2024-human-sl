...
\begin{enumerate}
	\item \textbf{Trustworthiness: } Although most algorithms have
		...
		biased towards sparse graphs \citep{Malinsky2024}.
		Consequently, researchers often have rely on post-hoc
		modifications based on model testing methods and their domain
		knowledge.
...
results of this test. Figure~\ref{fig:ci_testing} shows an example of testing
...
the most and can use their expertise to choose the most optimal modifications.
