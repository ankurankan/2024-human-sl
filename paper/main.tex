...
\begin{abstract}
	...
	where things like \emph{modification indices} can be used to guide this
	...
	combining the implied conditional independencies of the model, but
	there are no methods that can guide our modification process. In this
	paper, we present a simple modification process based on using a
	measure of association for these individual local CI tests and
