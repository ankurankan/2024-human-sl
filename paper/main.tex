...
conditioned on $ \mathbf{Z} $ as the effect size of the CI test $ X \ci Y |
\mathbf{Z} $. A greedy approach could be to choose the edge that has the
highest residual association between the variables.
Algorithm~\ref{algo:ranked_expand} outlines this approach. This approach has
the benefit that it prioritizes edges that improve the model fit the most.
