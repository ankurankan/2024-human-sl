...
Recently, there has been a lot of work towards utilizing LLMs for causal
discovery including approaches ranging from determining pairwise edge
orientation \citep{Kiciman2023, Jin2024} to full causal discovery
\citep{Naik2023, Vashishtha2023}, and counterfactual reasoning
tasks\citep{Kiciman2023} (see \citet{Liu2024} for an overview) As our approach
utilizes expert knowledge for determining the orientation of the edges, this
opened up an opportunity to use an LLM for determining this. We tried applying
our procedure for causal discovery with using GEMINI as the expert. We used a
greedy approach where the pair of variables with the highest unexplained
