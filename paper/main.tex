...
Our structure learning algorithm relies on suggesting modifications to the
expert based on CI testing. In this section, we show an example of how this
works. Our structure learning algorithm can be thought of an iterative
application of this model testing approach.
